'''
refer : https://sites.psu.edu/gottiparthyanirudh/writing-sample-3/
'''
...
#Input Prime Numbers
print("PLEASE ENTER THE 'p' AND 'q' VALUES BELOW (e.g., 17, 19, 23, etc):")
p = int(input("Enter a prime number for p: "))
q = int(input("Enter a prime number for q which is different from p : "))
print("*****************************************************")
...
if(choose=='1'):
    ...
    print("and the decryption is: ",decrypt(private,enc_msg))
elif(choose=='2'):
